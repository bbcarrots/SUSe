...
describe('updateUsageLogDB()', async () => {
  ...
  const usageLogInstance: UsageLogDBObj = {
	...
	it.todo('success: updated usage log in database', async () => {
		// returned UsageLogResponse upon successful insert into database
		const expectedState: UsageLogResponse = {
			success: true,
			usageLogRaws: null,
...
describe('selectUsageLogDB()', async () => {
  ...
  it.todo('success: multiple ULs with student number', async () => {
		const oneUsageLogFilter: UsageLogFilter = {
      usageLogID: 0,
      studentNumber: newSN,
      serviceType: [],
  ...
  it.todo('success: multiple ULs with mindate and maxdate', async () => {
		const oneUsageLogFilter: UsageLogFilter = {
      usageLogID: 0,
      studentNumber: newSN,
      serviceType: [],
