...
describe.skip('fail: Student.insertStudent with same SN or same username', () => {
...
describe.skip('Student.selectStudentDB', () => {
...
describe.skip('error: Student.selectStudentDB wrong input', () => {
